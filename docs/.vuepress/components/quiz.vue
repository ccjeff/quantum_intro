      ...
      return {
        ...
        questions: [
          new QuestionModel({
            id: 'html_1',
            title: 'Q1',
            helpText: 'Quantum computing is not based on binary bits, but qubits.',
          ...
          new QuestionModel({
            id: 'html_2',
            title: 'Q2',
            helpText: 'Shor algorithm can be used to break the Internet security barrier.',
            type: QuestionType.MultipleChoice,
            required: true,
            multiple: true,
            options: [
          ...
          new QuestionModel({
            id: 'html_3',
            title: 'Q3',
            helpText: 'Compared with the classic algorithm, the Shor algorithm can achieve exponential acceleration of calculation.',
            type: QuestionType.MultipleChoice,
            required: true,
            multiple: true,
            options: [
          ...
          new QuestionModel({
            id: 'html_4',
            title: 'Q4',
            helpText: 'Qubits and quantum computing are susceptible to various influences, so quantum computers are prone to errors.',
            type: QuestionType.MultipleChoice,
            required: true,
            multiple: true,
            options: [
          ...
          new QuestionModel({
            id: 'html_5',
            title: 'Q5',
            helpText: 'Quantum error correction can be realized in theory, but the cost of error correction is staggering.',
            type: QuestionType.MultipleChoice,
            required: true,
            multiple: true,
            options: [
          ...
          new QuestionModel({
            id: 'html_6',
            title: 'Q6',
            helpText: 'The number of qubits is not the only measure of quantum computers.',
            type: QuestionType.MultipleChoice,
            required: true,
            multiple: true,
            options: [
          ...
          new QuestionModel({
            id: 'html_7',
            title: 'Q7',
            helpText: 'After the RSA is cracked, the Internet and digital communications will fall apart.',
            type: QuestionType.MultipleChoice,
            required: true,
            multiple: true,
            options: [
          ...
          new QuestionModel({
            id: 'html_8',
            title: 'Q8',
            helpText: 'A qubit can be a superposition of 0 and 1. Multiple qubits are not isolated, but interact in a collective state.',
            type: QuestionType.MultipleChoice,
            required: true,
            multiple: true,
            options: [
          ...
          new QuestionModel({
            id: 'html_9',
            title: 'Q9',
            helpText: 'No matter when the encryption cracking can be realized, it is the most important application field of quantum computing.',
            type: QuestionType.MultipleChoice,
            required: true,
            multiple: true,
            options: [

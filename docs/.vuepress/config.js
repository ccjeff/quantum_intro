            ...
            nav: [   
                {
                    ...
                    ariaLabel: 'document_material',   //用于识别的label
                    items: [
                        { text: 'Motivation', link: '/pages/motivation/Motivation.md' },  
                        { text: 'Quantum Theory', link: '/pages/quantum_theory/quantum_entanglement.md' },
                        { text: 'Qubit', link: '/pages/qubit/qubit.md' },   
                        { text: 'Quantum Gate', link: '/pages/quantum_gate/Quantum_Gate.md' },
                        { text: 'Quantum Algorithms', link: '/pages/quantum_algorithm/HHL.md' },  
                ...
                { text: 'Lecture Video', link: '/pages/video_lecture/video.md' },  
